...
description: "「旅行地図を作成して」「旅行地図を更新して」「HTML地図を再生成して」「最新の旅行地図をGitHubへ反映して」と依頼されたときに使う。takahiro125-prog/Travel2026専用の、Google DriveとGoogle Sheetsの最新版を取得して旅行地図を再生成・検証し、安全にGitHubへ公開するスキル。"
---
